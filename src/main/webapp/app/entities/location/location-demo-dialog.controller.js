(function() {
    ...
    angular
        .module('linwiseApp')
        .controller('LocationDemoDialogController', LocationDemoDialogController);

    LocationDemoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Location', 'Country'];

    function LocationDemoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Location, Country) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('linwiseApp:locationUpdate', result);
