(function() {
    ...
    angular
        .module('linwiseApp')
        .controller('JobHistoryDemoDialogController', JobHistoryDemoDialogController);

    JobHistoryDemoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'JobHistory', 'Job', 'Department', 'Employee'];

    function JobHistoryDemoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, JobHistory, Job, Department, Employee) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('linwiseApp:jobHistoryUpdate', result);
