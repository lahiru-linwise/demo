(function() {
    ...
    angular
        .module('linwiseApp')
        .controller('CountryDemoDialogController', CountryDemoDialogController);

    CountryDemoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Country', 'Region'];

    function CountryDemoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Country, Region) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('linwiseApp:countryUpdate', result);
